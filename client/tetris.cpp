...
void Tetris::render_battle(TetrisBattle& tetris_battle)
{
    ...
    // Draw board data
    LemonTea::Board board_1_copy = tetris_battle.player_1.board;
    LemonTea::Board board_2_copy = tetris_battle.player_2.board;
    ...
    // Draw current piece
    for (int i = 0; i < 4; ++i) {
        if (tetris_battle.player_1.current != LemonTea::PIECE_NONE) {
            int x_off = LemonTea::PIECE_LUT[tetris_battle.player_1.current][tetris_battle.player_1.piece.rotation][i][0];
            int y_off = -LemonTea::PIECE_LUT[tetris_battle.player_1.current][tetris_battle.player_1.piece.rotation][i][1];
        ...
        if (tetris_battle.player_2.current != LemonTea::PIECE_NONE) {
            int x_off = LemonTea::PIECE_LUT[tetris_battle.player_2.current][tetris_battle.player_2.piece.rotation][i][0];
            int y_off = -LemonTea::PIECE_LUT[tetris_battle.player_2.current][tetris_battle.player_2.piece.rotation][i][1];
    ...
    int hold_y = 7;
    for (int i = 0; i < 4; ++i) {
        if (tetris_battle.player_1.hold != LemonTea::PIECE_NONE) {
            int x_off = LemonTea::PIECE_LUT[tetris_battle.player_1.hold][LemonTea::PIECE_UP][i][0];
            int y_off = -LemonTea::PIECE_LUT[tetris_battle.player_1.hold][LemonTea::PIECE_UP][i][1];
            this->draw(hold_1_x + x_off, hold_y + y_off, ConsoleEngine::PIXEL_SOLID, ConsoleEngine::COLOR_FG_WHITE);
        }
        if (tetris_battle.player_2.hold != LemonTea::PIECE_NONE) {
            int x_off = LemonTea::PIECE_LUT[tetris_battle.player_2.hold][LemonTea::PIECE_UP][i][0];
            int y_off = -LemonTea::PIECE_LUT[tetris_battle.player_2.hold][LemonTea::PIECE_UP][i][1];
    ...
    for (int y = 0; y < std::min(5, PLAYER_NEXT_COUNT); ++y) {
        for (int i = 0; i < 4; ++i) {
            if (tetris_battle.player_1.next[y] != LemonTea::PIECE_NONE) {
                int x_off = LemonTea::PIECE_LUT[tetris_battle.player_1.next[y]][LemonTea::PIECE_UP][i][0];
                int y_off = -LemonTea::PIECE_LUT[tetris_battle.player_1.next[y]][LemonTea::PIECE_UP][i][1];
                this->draw(next_1_x + x_off, next_y + y * 4 + y_off, ConsoleEngine::PIXEL_SOLID, ConsoleEngine::COLOR_FG_WHITE);
            }
            if (tetris_battle.player_2.next[y] != LemonTea::PIECE_NONE) {
                int x_off = LemonTea::PIECE_LUT[tetris_battle.player_2.next[y]][LemonTea::PIECE_UP][i][0];
                int y_off = -LemonTea::PIECE_LUT[tetris_battle.player_2.next[y]][LemonTea::PIECE_UP][i][1];
