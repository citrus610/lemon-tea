...
public:
	...
	static void bumpiness(int column_height[10], int result[2]);
	static void blocked_cell(bitboard& board, int column_height[10], int result[2]);
