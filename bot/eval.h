...
constexpr Weight DEFAULT_WEIGHT() 
{
    ...
    result.attack.clear[0] = -14300;
	result.attack.clear[1] = -10000;
	result.attack.clear[2] = -5800;
	...
	result.defence.well[8] = 3500;
	result.defence.well[9] = 3000;
	result.defence.structure[0] = 800;
	result.defence.structure[1] = 14800;
	result.defence.structure[2] = 19200;
